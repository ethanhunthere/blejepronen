      ...
      <div id="listing-gallery" className="relative">
        ...
        <div className="hidden md:grid h-[60vh] lg:h-[70vh] grid-cols-[1.5fr_1fr] grid-rows-2 gap-2 rounded-3xl overflow-hidden bg-gray-100">
          ...
          <div className="absolute top-4 left-4 z-10">
            <span className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-bold bg-[#03C988] text-white shadow-lg">
              {typeLabel}
            </span>
          </div>
          {featured && (
        ...
        <div className="md:hidden relative aspect-[4/3] rounded-2xl overflow-hidden bg-gray-100">
          ...
          <div className="absolute top-3 left-3 z-10">
            <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-[#03C988] text-white">
              {typeLabel}
            </span>
          </div>
          {featured && (
