    ...
    <div className="min-h-screen bg-[#F2F7F7] py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
          <PageHeader title="Politika e Privatësisë" />

          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">1. Të dhënat që mbledhim</h2>
            <p className="text-gray-600 leading-relaxed">
              Kur krijoni një llogari, mbledhim emrin, email-in dhe numrin e telefonit. Kur postoni një pronë, ruajmë informacionin e listimit dhe fotot e ngarkuara.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">2. Si i përdorim të dhënat</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">3. Cookies</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">4. Ruajtja e të dhënave</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">5. Siguria</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">6. Të drejtat tuaja</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#101828] mb-3">7. Kontakti</h2>
            <p className="text-gray-600 leading-relaxed">
              Për pyetje rreth privatësisë, na kontaktoni në:{' '}
              <a href="mailto:blejepronen@gmail.com" className="text-[#101828] hover:underline">blejepronen@gmail.com</a>
            </p>
          </section>
