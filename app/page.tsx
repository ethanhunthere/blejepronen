      ...
      {error && (
        <section className="w-full px-4 sm:px-6 lg:px-8 2xl:px-12 py-8">
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6 text-center">
            ...
            <Link
              href="/"
              className="inline-flex items-center justify-center w-full sm:w-auto min-h-[44px] h-11 px-5 bg-[#66C1B4] text-white rounded-xl font-semibold hover:bg-[#4CA195] hover:shadow-lg hover:shadow-[#66C1B4]/25 hover:-translate-y-[1px] active:translate-y-0 active:shadow-none transition-all duration-200 ease-out cursor-pointer"
            >
              Provo përsëri
            </Link>
          </div>
      ...
      <section aria-label="Banesat e disponueshme" className="bg-white w-full px-4 sm:px-6 lg:px-8 2xl:px-12 py-8 sm:py-12 lg:py-16">
        ...
        {listings.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#66C1B4] shadow-[0_12px_24px_-8px_rgba(0,100,89,0.5)] flex items-center justify-center">
            ...
            <Link href="/posto-banese">
              <Button className="h-11 w-full sm:w-auto px-5 bg-[#66C1B4] text-white rounded-xl font-semibold hover:bg-[#4CA195] hover:shadow-lg hover:shadow-[#66C1B4]/25 hover:-translate-y-[1px] active:translate-y-0 active:shadow-none transition-all duration-200 ease-out">
