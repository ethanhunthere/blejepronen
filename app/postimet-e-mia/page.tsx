        ...
        <div className="flex items-center gap-6 border-b border-gray-100 mb-8">
          <button
            ...
            className={`pb-3 text-sm cursor-pointer transition-colors duration-150 ${
              activeTab === 'mine' ? 'border-b-2 border-[#0D9488] text-[#0D9488] font-semibold' : 'text-gray-400 hover:text-gray-600'
            }`}
          >
            Postimet e mia
          </button>
          <button
            ...
            className={`pb-3 text-sm cursor-pointer transition-colors duration-150 ${
              activeTab === 'favorites' ? 'border-b-2 border-[#0D9488] text-[#0D9488] font-semibold' : 'text-gray-400 hover:text-gray-600'
            }`}
          >
            Të preferuarat
          </button>
        ...
        {activeTab === 'favorites' ? (
          ...
          <div className="flex flex-col items-center justify-center text-center py-20">
            ...
            <Link href="/posto-banese">
              <Button className="h-11 px-6 bg-[#0D9488] text-white rounded-xl font-semibold hover:bg-[#0F766E] hover:shadow-lg hover:shadow-[#0D9488]/25 hover:-translate-y-[1px] active:translate-y-0 active:shadow-none transition-all duration-200 ease-out">
                Posto banesën tënde
              </Button>
            </Link>
          </div>
