...
export default function Loading() {
  return (
    <div className="min-h-screen bg-[#0A0F2E]">
      {/* Hero skeleton */}
      <div className="bg-[#0A0F2E] border-b border-white/10 py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <div className="h-6 max-w-xs w-full bg-white/10 rounded-full animate-pulse mx-auto mb-6" />
            <div className="h-12 max-w-sm w-full bg-white/10 rounded-xl animate-pulse mx-auto mb-4" />
            <div className="h-12 max-w-xs w-full bg-white/10 rounded-xl animate-pulse mx-auto mb-10" />
      ...
      {/* Stats skeleton */}
      <div className="bg-[#0D1235] border-t border-white/10">
      ...
      <section className="bg-[#0A0F2E] border-y border-white/10 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-8 w-56 bg-white/10 rounded animate-pulse mx-auto mb-12" />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map(i => (
              <div key={i} className="text-center">
                <div className="w-16 h-16 bg-white/10 rounded-full animate-pulse mx-auto mb-4" />
                <div className="h-5 w-20 bg-white/10 rounded animate-pulse mx-auto mb-2" />
