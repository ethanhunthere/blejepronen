        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-3 overflow-x-auto">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="h-16 w-20 flex-shrink-0 rounded-lg bg-gray-200 animate-pulse" />
              ))}
            </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl p-6 border border-gray-100 sticky top-24 space-y-4">
              {/* Price */}
