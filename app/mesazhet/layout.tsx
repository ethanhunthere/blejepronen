      ...
      >
        ...
        <div className="flex-shrink-0 px-5 py-5 bg-white border-b border-gray-100">
          <div className="flex items-center justify-between mb-4">
            ...
            {totalUnread > 0 && (
              <span className="bg-[#66C1B4] text-white text-[11px] font-bold min-w-[22px] h-[22px] rounded-full flex items-center justify-center px-1.5 shadow-lg shadow-[#66C1B4]/30 animate-pulse"
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="relative w-full bg-gray-50 border border-gray-200 rounded-2xl pl-10 pr-4 py-2.5 text-sm text-[#1A1A2E] placeholder:text-gray-400 focus:outline-none focus:border-[#66C1B4]/30 transition-all duration-300"
            />
          </div>
        </div>
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center gap-3 p-3 rounded-2xl text-left transition-all duration-200 ease-out group border-b border-gray-50 cursor-pointer ${
                      isActive
                        ? 'bg-[#66C1B4]/5 border-l-2 border-l-[#66C1B4]'
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {conv.unreadCount > 0 && (
                          <span className="bg-[#66C1B4] text-white text-[10px] font-bold min-w-[20px] h-[20px] rounded-full flex items-center justify-center px-1.5 flex-shrink-0 shadow-md shadow-[#66C1B4]/25"
