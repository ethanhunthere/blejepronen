      ...
      <div className="h-[calc(100vh-64px)] flex items-center justify-center bg-[#F2F7F7]">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-5 h-5 border-2 border-gray-200 border-t-[#66C1B4] rounded-full animate-spin" />
          </div>
        </div>
      </div>
    )
              ...
              >
                ...
                <div
                  className={`max-w-[75%] md:max-w-[60%] px-3 py-1 text-sm leading-snug ${
                    isMine
                      ? 'bg-[#66C1B4] text-white rounded-2xl rounded-br-md'
      ...
      <footer className="flex-shrink-0 bg-white border-t border-gray-100 px-4 py-3">
        <div className="max-w-3xl mx-auto flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 bg-gray-50 border border-gray-200 rounded-2xl px-4 py-2.5 text-[#1A1A2E] text-sm placeholder:text-gray-400 resize-none min-h-[40px] max-h-[100px] focus:border-[#66C1B4]/40 focus:outline-none transition-all duration-200"
            onInput={e => {
          ...
          <div className="flex flex-col items-center gap-0.5">
            <button
              ...
              className="w-10 h-10 bg-[#66C1B4] rounded-full flex items-center justify-center flex-shrink-0 hover:bg-[#4CA195] hover:shadow-lg hover:shadow-[#66C1B4]/25 hover:scale-105 active:scale-95 disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none transition-all duration-200 ease-out cursor-pointer"
            >
