      ...
      <div className="w-full px-4 sm:px-6 py-10">
          ...
          <Alert variant="destructive" className="mb-6">
            ...
            <div className="mt-3">
              <Link
                ...
                className="inline-flex items-center justify-center min-h-[44px] rounded-lg px-4 py-2 text-sm font-semibold bg-[#0D9488] text-white hover:bg-[#0F766E] hover:shadow-lg hover:shadow-[#0D9488]/25 hover:-translate-y-[1px] active:translate-y-0 active:shadow-none transition-all duration-200 ease-out cursor-pointer"
              >
                Verifiko profilin
              </Link>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                className="mt-1 h-11 bg-white text-[#1A1A2E] placeholder:text-gray-400 border-gray-200 focus:border-[#0D9488]/50"
            ...
            <div>
              ...
              <textarea
                ...
                className="mt-1 w-full min-h-[120px] px-3 py-2 rounded-lg border border-gray-200 text-sm bg-white text-[#1A1A2E] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0D9488]/50 resize-none"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="mt-1 w-full h-11 px-3 rounded-lg border border-gray-200 text-sm bg-white text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#0D9488]/50"
                  value={formData.city}
                  onChange={handleChange}
                  required
                >
              ...
              <div>
                ...
                <select
                  ...
                  name="neighborhood"
                  style={{ colorScheme: 'light' }}
                  className="mt-1 w-full h-11 px-3 rounded-lg border border-gray-200 text-sm bg-white text-[#1A1A2E] focus:outline-none focus:ring-2 focus:ring-[#0D9488]/50 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <Button
            type="submit"
            disabled={uploading}
            className="w-full h-12 bg-[#0D9488] text-white text-base font-semibold py-4 rounded-xl hover:bg-[#0F766E] hover:shadow-lg hover:shadow-[#0D9488]/25 hover:-translate-y-[1px] active:translate-y-0 active:shadow-none transition-all duration-200 ease-out cursor-pointer disabled:hover:translate-y-0 disabled:hover:shadow-none"
          >
            {uploading ? (
              <>
