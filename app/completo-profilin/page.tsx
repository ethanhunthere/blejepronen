        ...
        <div className="flex items-center justify-center gap-3 mb-8">
          {([1, 2] as Step[]).map((s) => (
            <div key={s} className="flex items-center gap-3">
              ...
              {s < 2 && (
                <div className={`w-12 h-0.5 rounded-full transition-colors duration-300 ${s < step ? 'bg-[#0D9488]' : 'bg-gray-200'}`} />
              )}
            </div>
          ))}
        </div>
          ...
          {step === 1 && (
            <>
              ...
              <form onSubmit={handleStep1Submit} className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="firstName"
                      placeholder="Emri yt"
                      className="pl-11 h-12 rounded-xl bg-white border-gray-200 text-[#1A1A2E] placeholder:text-gray-400 focus:border-[#0D9488]/60"
                      value={firstName}
                ...
                <Button
                  type="submit"
                  className="w-full h-12 rounded-xl font-semibold text-white bg-[#0D9488] shadow-lg shadow-[#0D9488]/25 hover:bg-[#0F766E] hover:-translate-y-[1px] active:translate-y-0 active:shadow-none transition-all duration-200 ease-out cursor-pointer disabled:hover:translate-y-0"
                  disabled={loading}
                >
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-center">
                  <Input
                    ...
                    className="w-48 h-16 text-center text-4xl font-bold tracking-[0.5em] bg-white border border-gray-200 rounded-xl text-[#1A1A2E] placeholder:text-gray-300 focus:border-[#0D9488]/60"
                  />
                </div>
