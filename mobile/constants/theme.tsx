...
export const THEMES: Record<ThemeMode, ThemeColors> = {
  ...
  green: {
    mode: 'green',
    primary: '#D4AF37', // 24K Venetian champagne gold stands out boldly against velvet emerald
    primaryDark: '#071C18',
    primaryLight: 'rgba(212, 175, 55, 0.16)',
    gold: '#D4AF37',
    goldLight: 'rgba(212, 175, 55, 0.22)',
    background: '#071C18', // Deep velvet midnight-emerald canvas providing infinite depth
    surface: '#0E332A', // Elevated royal emerald container with optical lightness
    surfaceSubtle: '#144237',
    surfaceHighlight: '#1A5346',
    border: 'rgba(212, 175, 55, 0.22)', // Hairline champagne gold specular border
